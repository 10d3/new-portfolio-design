...
const DATA = {
  ...
  contact: {
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/10d3",
        icon: Icons.github,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/aherleym/",
        icon: Icons.linkedin,
      },
      X: {
        name: "X",
...
export default function Navbar() {
  return (
    <nav className="relative flex h-auto w-full flex-col items-center justify-center overflow-hidden">
