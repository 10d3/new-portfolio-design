			...
			>
				...
				{editor?.isEditable && (
					<>
						...
						<div
							className={cn(
								"floating-toolbar absolute right-4 top-4 opacity-0 transition-opacity",
						...
						>
							<button
								...
								className={cn(
									...
									node.attrs.align === "left" && "floating-toolbar-button--active",
								)}
								onClick={() => {
									updateAttributes({
										align: "left",
							...
							<button
								...
								className={cn(
									"floating-toolbar-button",
									node.attrs.align === "center" && "floating-toolbar-button--active",
								)}
								onClick={() => {
									updateAttributes({
										align: "center",
							...
							<button
								...
								className={cn(
									"floating-toolbar-button",
									node.attrs.align === "right" && "floating-toolbar-button--active",
								)}
								onClick={() => {
									updateAttributes({
										align: "right",
							...
							>
								<DropdownMenuTrigger asChild>
									<button type="button" className="floating-toolbar-button">
