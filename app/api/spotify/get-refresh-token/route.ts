...
export async function POST() {
  try {
    ...
    console.log('✅ Client Credentials Token:', tokenData.access_token.substring(0, 20) + '...');
    console.log('⚠️  This token CANNOT access user data like currently playing tracks');
